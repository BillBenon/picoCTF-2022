...
const XSSSubmission = () => {
    const [url, setUrl] = (0, hooks_1.useLocalStorage)("xss-submission-url", "http://example.com");
    const [state, setState] = React.useState({ kind: "initial" });
    const introduction = React.useMemo(() => (0, utils_1.randomSelect)(introductions), []);
    const link = React.useMemo(() => (0, utils_1.randomSelect)(links), []);
    const signoff = React.useMemo(() => (0, utils_1.randomSelect)(signoffs), []);
    const person = React.useMemo(() => (0, utils_1.randomSelect)(people), []);
...
exports.XSSSubmission = XSSSubmission;
